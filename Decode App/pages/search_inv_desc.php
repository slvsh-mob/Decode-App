...
<div class="row" style="margin: 0;">
    <div class="col s12 grey lighten-3" style="height: 15vh; border-bottom: 1px solid black;">
        <div class="col s4 offset-s2">
            <p style="padding-top: 1em; float: right; font-size: 30px;"><b>Search By Product Description:</b></p>
        </div>
        <div class="col s3">
            <input type="text" placeholder="Product Code" style="padding-top: 2em; font-size: 30px;" id="this_input">
        </div>
        <div class="col s3">
            <button class="btn-large" style="margin-top: 4em; margin-left: 2em;" onclick="SEARCH();">Search</button>
            <button class="btn-large" style="margin-top: 4em; margin-left: 2em; onclick="resetTable();">Reset</button>
        </div>
    </div>
</div>
<?php
...
?>
    ...
    function resetTable(){
        var search_bar = document.getElementById("this_input");
        search_bar.value = "";
        chunking(input_array);
        drawTable();
    }
    ...
    function SEARCH(){
        ...
        searchPID(input_array, search_term);
    }
</script>
