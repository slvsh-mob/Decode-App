<?php
$page_title = "Add Incoming Product";
...
$supplier_list = $suppliers->readToArray();
?>
    ...
    <div class="col s10 offset-s1">
        ...
        <div class="row">
            ...
            { 
                ...
                $output_array = [];
                $output_array['pid'] = $product_code;
                $output_array['supplier_name'] = $supplier_name;
                $output_array['description'] = $product_name;
                $output_array['category_id'] = $protein_type;

                $return = $products->addProduct($output_array);
            ...
            <h1 class="col s10 offset-s1">Add New Incoming Product</h1>
        </div>
        ...
        <div class="row">
            <select name="supplier_name" id="supplier_name" class="browser-default col s6 offset-s2">
            <?php
                foreach($supplier_list as $supplier){
                    $temp_id = $supplier['id'];
                    $temp_supplier = $supplier['name'];
                    echo "<option value=" . $temp_supplier . ">" . $temp_supplier . "</option>";
                }
            ?>
            </select>
        </div>
