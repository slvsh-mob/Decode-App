<?php
    ...
    $receiving = new Receiving($db);
    $output = $receiving->readToArray();
?>
    ...
    <div class="col s9 right">
        ...
        <div class="row">
            ...
            <table class='centered striped' id='receiving_summary_table' style='height: 80vh;'>
                <tr>
                    <th class='center-align'>ID</th>
                    <th class='center-align'>Supplier</th>
                    <th class='center-align'>Exp Qty</th>
                    <th class='center-align'>Exp Weight</th>
                    <th class='center-align'>Act Qty</th>
                    <th class='center-align'>Act Weight</th>
...
<script type="text/javascript">
    ...
    var table_name = document.getElementById('receiving_summary_table');
