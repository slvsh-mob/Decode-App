...
$output = $suppliers->readSuppliers();
?>
    ...
    <div class="col s9 right">
        ...
        <div class="row">
            <div class="col s10 offset-s1">
                <table class='centered striped' id='supplier_table' style='height: 80vh;'>
                    <tr>
                        <th class='center-align' width="40%">ID</th>
                        <th class='center-align' width="60%">Name</th>
                    </tr>
                </table>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var table_name = document.getElementById('supplier_table');
