<?php
$page_title = "Outgoing Product List";
...
$output = $outgoing_products->readToArray();
?>
    ...
    <div class="col s9 right">
        ...
        <div class="row">
            <div class="col s10 offset-s1">
                <table class='centered striped' id='outgoing_product_table' style='height: 80vh;'>
                    <tr>
                        <th class='center-align' width='10%'>ID</th>
                        <th class='center-align' width='20%'>Product Code</th>
                        <th class='center-align' width='50%'>Description</th>
                        <th class='center-align' width='20%'>Category ID</th>
                    </tr>
                </table>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var table_name = document.getElementById('outgoing_product_table');
