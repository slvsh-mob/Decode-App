<?php 
$page_title = "Produce Inventory";
include_once "../static/layout_header.php";
include_once '../static/inventory_sidebar.php';

$database = new Database();
$db = $database->getConnection();

$vegetable = new Vegetable($db);
$output = $vegetable->readToArray();
?>
...
<div class="col s9 right">
        ...
        <div class="row">
            ...
            <table class='centered striped' id='produce_inventory_table' style='height: 80vh;'>
                <tr>
                    <th class='center-align'>Vegetable</th>
...
<script type="text/javascript">
    ...
    var table_name = document.getElementById('produce_inventory_table');
